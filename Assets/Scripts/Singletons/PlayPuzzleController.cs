...
{
    public class PlayPuzzleController : MonoBehaviour
    {
        [FollowMachine("Restore Play history", "Success,Fail,Not Register")]
        public IEnumerator RestorePlayHistory(int? playerID)
        {
            if (playerID == null)
            {
